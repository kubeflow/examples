    ...
    RED.nodes.registerType('data process', {
        ...
        oneditprepare: function() {
            ...
            function toggleVisibility() {
                ...
                $(".toggle-fillnarequirement,.toggle-fillna,.toggle-fillnavalue,.toggle-datapath,.toggle-labelencodingrequirement,.toggle-labelencoding,.toggle-onehotencodingrequirement,.toggle-onehotencoding,.toggle-featurescalingrequirement,.toggle-featurescaling,.toggle-datareshape,.toggle-2D").hide();
            ...
            $procedures.add($fillnaRequirement).add($fillna).add($labelRequirement).add($onehotRequirement).add($featureScalingRequirement).add($dataReshape).on("change", toggleVisibility);
