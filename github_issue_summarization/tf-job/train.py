...
def main():
  ...
  logging.info(f'Train: {traindf.shape[0]:,} rows {traindf.shape[1]:,} columns')
  logging.info(f'Test: {testdf.shape[0]:,} rows {testdf.shape[1]:,} columns')
  ...
  logging.info('Example original body:', train_body_raw[0])
  logging.info('Example body after pre-processing:', train_body_vecs[0])
  ...
  logging.info('Example original title:', train_title_raw[0])
  logging.info('Example title after pre-processing:', train_title_vecs[0])
