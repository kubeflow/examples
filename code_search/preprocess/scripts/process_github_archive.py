...
def parse_arguments(args):
    ...
    parser.add_argument('-o', '--output', metavar='', help='Output string of the format <dataset>:<table>')
    ...
    parser.add_argument('--storage-bucket', metavar='', default='gs://bucket', help='Path to Google Storage Bucket')
...
def main(args):
    ...
    (pipeline | BigQueryGithubFiles(args.project, query_string, args.output))
    pipeline.run()
