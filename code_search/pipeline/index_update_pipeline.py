...
def dataflow_function_embedding_op(
  ...
  return default_gcp_op(
    ...
    image='gcr.io/kubeflow-examples/code-search/ks:v20181202-1d68b39-dirty-c1aa68',
...
def function_embedding_update(
  ...
  function_embedding = dataflow_function_embedding_op(
                            ...
                            function_embeddings_dir, saved_model_dir, workflow_name,
                            worker_machine_type, function_embedding_num_workers, working_dir,
                            namespace)
