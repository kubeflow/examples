...
def dataflow_function_embedding_op(project: 'GcpProject', cluster_name: str, target_dataset: str,data_dir: 'GcsUri',
...
def function_embedding_update(
    ...
    function_embedding = dataflow_function_embedding_op(project,cluster_name,target_dataset, data_dir,saved_model_dir,
