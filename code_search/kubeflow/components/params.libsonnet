{
  ...
  components: {
    "t2t-job": {
      ...
      train_steps: 100,
      eval_steps: 10,
      image: 'gcr.io/kubeflow-dev/code-search:v20180816-3c14910',
      imageGpu: 'gcr.io/kubeflow-dev/code-search:v20180816-3c14910-gpu',
      imagePullSecrets: [],
      dataDir: 'null',
      outputDir: 'null',
      model: 'null',
    ...
    nmslib: {
      replicas: 1,
      image: 'gcr.io/kubeflow-dev/code-search-ui:v20180816-2da3c43',
      problem: 'null',
      dataDir: 'null',
      lookupFile: 'null',
      indexFile: 'null',
