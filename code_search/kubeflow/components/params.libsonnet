{
  ...
  components: {
    "t2t-job": {
      ...
      train_steps: 100,
      eval_steps: 10,
      image: 'gcr.io/kubeflow-dev/code-search:v20180816-5fb7f7a',
      imageGpu: 'gcr.io/kubeflow-dev/code-search:v20180816-5fb7f7a-gpu',
      imagePullSecrets: [],
      dataDir: 'null',
      outputDir: 'null',
      model: 'null',
    ...
    nmslib: {
      replicas: 1,
      image: 'gcr.io/kubeflow-dev/code-search-ui:v20180816-3e388ef',
      problem: 'null',
      dataDir: 'null',
      lookupFile: 'null',
      indexFile: 'null',
