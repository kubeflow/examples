...
// https://cloud.google.com/cloud-build/docs/speeding-up-builds#using_a_cached_docker_image
{
    ...
    },
    {
      "id": "build-cpu",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["build", "-t", std.extVar("imageBase") + "/t2t-cpu:" + std.extVar("tag"), 
    ...
    },
    {
      "id": "tag-cpu",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["tag", std.extVar("imageBase") + "/t2t-gpu:" + std.extVar("tag"), 
               std.extVar("imageBase") + "/t2t-cpu" + ":latest",],
      "waitFor": ["build-cpu"],
    },    
    {
      "id": "pull-gpu",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["pull", std.extVar("imageBase") + "/t2t-gpu:" + "latest"],
      "waitFor": ["-"],
    },
    {
      "id": "build-gpu",
      "name": "gcr.io/cloud-builders/docker",      
      "args": ["build", "-t", std.extVar("imageBase") + "/t2t-gpu:" + std.extVar("tag"), 
             	 "--label=git-versions=" + std.extVar("gitVersion"), 
    ...
    },    
    {
      ...
      "name": "gcr.io/cloud-builders/docker",
      "args": ["tag", std.extVar("imageBase") + "/t2t-gpu" + std.extVar("tag"), 
               std.extVar("imageBase") + "/t2t-gpu:" + latest",],
      "waitFor": ["build-gpu"],
    },
    {
      "id": "pull-dataflow",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["pull", std.extVar("imageBase") + "/dataflow:" + "latest"],
      "waitFor": ["-"],
    },
    {
      "id": "build-dataflow",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["build", "-t", std.extVar("imageBase") + "/dataflow:" + std.extVar("tag"), 
               "--label=git-versions=" + std.extVar("gitVersion"),
    ...
    },
    {
      "id": "tag-dataflow",
      "name": "gcr.io/cloud-builders/docker",
      "args": ["tag", std.extVar("imageBase") + "/dataflow:" + std.extVar("tag"), 
               std.extVar("imageBase") + "/dataflow: + "latest",],
