{
  ...
  components: {
    "train": {
      ...
      image: "gcr.io/kubeflow-rl/agents:0319-2301-fb02",
      image_gpu: "null",
      ...
      log_dir: "/mnt/nfs-1/train_dirs/kubeflow-rl/studies/replicated-kuka-demo-1/kuka-0319-2308-da1e",
      max_length: 1000,
      name: "kuka-0319-2308-da1e",
      namespace: "kubeflow",
