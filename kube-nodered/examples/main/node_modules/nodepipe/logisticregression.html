...
<script type="text/x-red" data-template-name="logisticRegression">
  ...
  <div class="form-row">
    ...
    <input type="text" id="node-input-pyfile" value="/data/1.connect-kubeflow/py/logisticRegression.py" readonly>
  </div>
  <div class="form-row">
...
<script type="text/javascript">
  ...
  RED.nodes.registerType('logisticRegression',{
    ...
    defaults: {
      name: {required: false},
      pyfile: {value: "/data/1.connect-kubeflow/py/logisticRegression.py"},
    ...
    align: "left",
    label: function() {
        return this.name || "logisticRegression";
    },
    labelStyle: function() {
