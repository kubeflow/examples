...
-->
<script type="text/x-red" data-template-name="randomForest">
  ...
  <div class="form-row">
    ...
    <input type="text" id="node-input-pyfile" value="/data/1.connect-kubeflow/py/randomForest.py" readonly>
  </div>
  <div class="form-row">
...
<script type="text/x-red" data-help-name="randomForest">
...
<script type="text/javascript">
  ...
  RED.nodes.registerType('randomForest',{
    category: 'input',
    defaults: {
      name: {required: false},
      pyfile: {value: "/data/1.connect-kubeflow/py/randomForest.py"},
