...
local envParams = params + {
  components+: {
    ...
    gis+: {
      namespace: 'kubeflow-test-infra',
      name: 'jlewi-gis-search-test-456-1230-161123',
      prow_env: 'JOB_NAME=gis-search-test,JOB_TYPE=presubmit,REPO_NAME=examples,REPO_OWNER=kubeflow,BUILD_NUMBER=1230-161123,BUILD_ID=1230-161123,PULL_NUMBER=456',
    },
  },
};
