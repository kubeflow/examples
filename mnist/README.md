...
Mount the pvc to storge the exported model, by default the pvc will be mounted to the `/mnt` of the training pod.
...
The section shows how to serve the local model that was storaged in PVC while training.
